...
@file: MinimumBoundingBox.py

@time: 2017/10/31 下午6:56
...
def rectangle_corners(rectangle):
    ...
    for i1 in (.5, -.5):
        for i2 in (i1, -1 * i1):
            corner_points.append((rectangle['rectangle_center'][0] + i1 *
                                  rectangle['length_parallel'],
                                  rectangle['rectangle_center'][1] + i2 *
                                  rectangle['length_orthogonal']))
